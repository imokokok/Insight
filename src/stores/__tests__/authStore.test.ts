...
describe('authStore', () => {
  ...
  describe('用户登录状态管理', () => {
    ...
    it('initialize 应该清理之前的订阅', async () => {
      ...
      useAuthStore.setState({ subscription: oldSubscription as unknown as typeof mockSubscription });
    ...
    it('cleanup 应该取消订阅', () => {
      useAuthStore.setState({ subscription: mockSubscription as unknown as typeof mockSubscription });
