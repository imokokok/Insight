...
export const oracleConfigs: Record<OracleProvider, OracleConfig> = {
  ...
  [OracleProvider.BAND_PROTOCOL]: {
    ...
    supportedChains: [Blockchain.COSMOS, Blockchain.JUNO, Blockchain.OSMOSIS],
    ...
    networkData: {
      ...
      dataFeeds: 200,
      hourlyActivity: [
        1200, 1100, 1000, 900, 850, 900, 1200, 1800, 2500, 3200, 3800, 4200, 4000, 3800, 3600, 3700,
        3900, 4100, 4000, 3400, 2900, 2300, 1800, 1500,
      ],
      status: 'online',
      latency: 95,
