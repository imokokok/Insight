...
export const oracleConfigs: Record<OracleProvider, OracleConfig> = {
  ...
  [OracleProvider.DIA]: {
    ...
    tabs: [
      ...
      { id: 'cross-oracle', labelKey: 'dia.tabs.crossOracle' },
  ...
  [OracleProvider.TELLOR]: {
    ...
    tabs: [
      ...
      { id: 'cross-oracle', labelKey: 'tellor.tabs.crossOracle' },
  ...
  [OracleProvider.WINKLINK]: {
    ...
    tabs: [
      ...
      { id: 'cross-oracle', labelKey: 'winklink.menu.crossOracleComparison' },
    ],
  },
};
