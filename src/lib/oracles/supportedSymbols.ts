...
export const PYTH_AVAILABLE_PAIRS: Record<string, string[]> = {
  ethereum: ['BTC', 'ETH', 'SOL', 'AVAX', 'LINK', 'BNB', 'ARB', 'OP', 'PYTH', 'DOT', 'UNI', 'ATOM'],
  arbitrum: ['BTC', 'ETH', 'SOL', 'AVAX', 'LINK', 'BNB', 'ARB', 'OP', 'PYTH', 'DOT', 'UNI', 'ATOM'],
  optimism: ['BTC', 'ETH', 'SOL', 'AVAX', 'LINK', 'BNB', 'ARB', 'OP', 'PYTH', 'DOT', 'UNI', 'ATOM'],
  polygon: ['BTC', 'ETH', 'SOL', 'AVAX', 'LINK', 'BNB', 'ARB', 'OP', 'PYTH', 'DOT', 'UNI', 'ATOM'],
  solana: ['BTC', 'ETH', 'SOL', 'AVAX', 'LINK', 'BNB', 'ARB', 'OP', 'PYTH', 'DOT', 'UNI', 'ATOM'],
  avalanche: [
    'BTC',
    'ETH',
    'SOL',
  ...
  aptos: ['BTC', 'ETH', 'SOL', 'AVAX', 'LINK', 'BNB', 'ARB', 'OP', 'PYTH', 'DOT', 'UNI', 'ATOM'],
  sui: ['BTC', 'ETH', 'SOL', 'AVAX', 'LINK', 'BNB', 'ARB', 'OP', 'PYTH', 'DOT', 'UNI', 'ATOM'],
  base: ['BTC', 'ETH', 'SOL', 'AVAX', 'LINK', 'BNB', 'ARB', 'OP', 'PYTH', 'DOT', 'UNI', 'ATOM'],
};
