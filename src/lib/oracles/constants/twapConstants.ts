...
export const TWAP_TOKEN_ADDRESSES: Record<string, Record<number, `0x${string}`>> = {
  ...
  CBBTC: {
    1: '0xcbb7c0000ab88b473b1f5afD9ef808440eE33d29',
  },
  CVX: {
  ...
  GALA: {
    1: '0x15D4c048F83bd7e37d49eA4C83a07267Ec4203dA',
  },
  GRT: {
    1: '0xc944E90C64B2c07662A292be6244BDf05Cda44a7',
  },
  INJ: {
    1: '0xe28B3b32b6C345a34ff64674609024ea28cea6F7',
  },
  KNC: {
  ...
  OCEAN: {
    1: '0x967da4048cD07aB37855c090af366E4Ce1B9f48f',
  },
  PAXG: {
