...
describe('Card', () => {
  ...
  it('should render with bordered variant', () => {
    render(<Card data-testid="card" variant="bordered">Bordered card</Card>);
  ...
  it('should render with filled variant', () => {
    render(<Card data-testid="card" variant="filled">Filled card</Card>);
  ...
  it('should render with interactive variant', () => {
    render(<Card data-testid="card" variant="interactive">Interactive card</Card>);
  ...
  it('should render with different sizes', () => {
    ...
    rerender(<Card data-testid="card" size="md">Medium card</Card>);
    card = screen.getByTestId('card');
    expect(card).toHaveClass('p-5');
    
    rerender(<Card data-testid="card" size="lg">Large card</Card>);
    card = screen.getByTestId('card');
