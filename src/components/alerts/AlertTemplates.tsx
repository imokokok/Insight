...
function getPresetTemplates(): AlertTemplate[] {
  return [
    ...
    },
    {
      id: 'data_delay',
      name: 'Data Delay',
      description: 'Alert when oracle data is older than 60 seconds',
      icon: 'data_delay',
      category: 'data',
      config: {
        symbol: 'ETH',
    ...
    {
      id: 'oracle_disagreement',
      name: 'Oracle Disagreement',
      description: 'Alert when oracles disagree by more than 2%',
      icon: 'deviation_alert',
      category: 'custom',
      config: {
        symbol: 'BTC',
        provider: '',
        chain: '',
        condition_type: 'oracle_disagreement',
        target_value: 2,
        is_active: true,
      },
    },
    {
      ...
      description: 'Alert when an oracle deviates from median by more than 1%',
      icon: 'deviation_alert',
      category: 'custom',
      config: {
        symbol: 'ETH',
        provider: '',
        chain: '',
        condition_type: 'deviation_from_median',
        target_value: 1,
        is_active: true,
      },
    },
    {
      ...
      description: 'Alert when oracle confidence drops below 0.9',
      icon: 'data_delay',
      category: 'data',
      config: {
        symbol: 'BTC',
        provider: '',
        chain: '',
        condition_type: 'confidence_drop',
        target_value: 0.9,
        is_active: true,
      },
    },
    {
      ...
      description: 'Auto-alert when price anomaly is detected',
      icon: 'volatility_spike',
      category: 'custom',
      config: {
        symbol: 'BTC',
        provider: '',
        chain: '',
        condition_type: 'anomaly_detected',
        target_value: 2,
        is_active: true,
      },
    },
