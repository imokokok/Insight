  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <DashboardCard title="数据提供者数量" className="bg-gradient-to-br from-purple-50 to-pink-50">
          <div className="text-center">
        ...
        <DashboardCard title="平均声誉评分" className="bg-gradient-to-br from-green-50 to-emerald-50">
          <div className="text-center">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {providers.map((provider) => (
                <tr key={provider.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <span className="text-sm text-gray-900">{(provider.reputation * 100).toFixed(0)}%</span>
      ...
      {/* RedStone 架构说明 */}
      <DashboardCard title="RedStone 模块化架构">
      ...
      <DashboardCard title="资产覆盖范围">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {['BTC', 'ETH', 'SOL', 'AVAX', 'LINK', 'UNI', 'AAVE', 'SNX', 'CRV', 'LDO'].map((asset) => (
            <span key={asset} className="px-3 py-1 bg-red-100 text-red-700 text-sm font-medium rounded-full">
              {asset}
            </span>
          ))}
