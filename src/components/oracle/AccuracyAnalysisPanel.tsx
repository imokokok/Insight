...
export function AccuracyAnalysisPanel() {
  ...
  const { stats, extremeEvents, accuracyTrend, recentTrend, isLoading } = usePriceHistory(100);
          ...
          <div>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-white text-purple-600 text-sm font-medium rounded-lg border border-purple-200 hover:bg-purple-50 transition-colors"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    strokeLinecap="round"
