      ...
      <main className="flex-1 bg-dune">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          {activeTab === 'gaming' && config.provider === OracleProvider.WINKLINK && (
            <div className="mb-6">
              <WINkLinkGamingDataPanel data={{
                totalGamingVolume: 850000000,
                activeGames: 45,
                dailyRandomRequests: 2500000,
                dataSources: [
                  { id: 'game-001', name: 'WINk Casino', type: 'platform', category: 'casino', users: 650000, volume24h: 8500000, dataTypes: ['Random Numbers', 'Price Feeds'], reliability: 99.99, lastUpdate: Date.now() },
                  { id: 'game-002', name: 'TRONbet Dice', type: 'game', category: 'casino', users: 280000, volume24h: 3200000, dataTypes: ['Random Numbers'], reliability: 99.97, lastUpdate: Date.now() - 30000 },
                  { id: 'game-003', name: 'SportX', type: 'platform', category: 'sports', users: 420000, volume24h: 5800000, dataTypes: ['Sports Results', 'Price Feeds'], reliability: 99.95, lastUpdate: Date.now() - 60000 },
                ],
                randomNumberServices: [
                  { serviceId: 'rng-001', name: 'WINkLink VRF', requestCount: 15000000, averageResponseTime: 85, securityLevel: 'high', supportedChains: ['TRON', 'BTTC'] },
                  { serviceId: 'rng-002', name: 'Gaming Random Oracle', requestCount: 8500000, averageResponseTime: 95, securityLevel: 'high', supportedChains: ['TRON'] },
                ],
                vrfUseCases: [
                  { id: 'vrf-001', name: 'Random Number Generation', description: 'Secure random numbers for gaming', category: 'gaming', usageCount: 15000000, reliability: 99.99 },
                  { id: 'vrf-002', name: 'Lottery Draw', description: 'Fair lottery drawing mechanism', category: 'lottery', usageCount: 5200000, reliability: 99.98 },
                ],
          ...
          {activeTab === 'tron' && config.provider === OracleProvider.WINKLINK && (
            <div className="mb-6">
              <WINkLinkTRONEcosystemPanel data={{
                networkStats: {
                ...
                integratedDApps: [
                  { id: 'dapp-001', name: 'WINk', category: 'gaming', users: 850000, volume24h: 15000000, contractAddress: 'TND...abc', integrationDate: Date.now() - 86400000 * 365, status: 'active' },
                  { id: 'dapp-002', name: 'JustSwap', category: 'defi', users: 420000, volume24h: 8500000, contractAddress: 'TND...def', integrationDate: Date.now() - 86400000 * 300, status: 'active' },
                ],
          ...
          {activeTab === 'staking' && config.provider === OracleProvider.WINKLINK && (
            <div className="mb-6">
              <WINkLinkStakingPanel data={{
                ...
                nodes: [
                  { id: 'node-001', address: 'TND...1a2b', name: 'WINkLink Guardian', region: 'Asia', stakedAmount: 5000000, rewardsEarned: 850000, uptime: 99.99, responseTime: 85, validatedRequests: 12500000, joinDate: Date.now() - 86400000 * 400, status: 'active', tier: 'platinum' },
                  { id: 'node-002', address: 'TND...2c3d', name: 'TRON Oracle Node', region: 'Europe', stakedAmount: 3200000, rewardsEarned: 520000, uptime: 99.95, responseTime: 95, validatedRequests: 9800000, joinDate: Date.now() - 86400000 * 350, status: 'active', tier: 'gold' },
                ],
              }} />
            </div>
          )}
