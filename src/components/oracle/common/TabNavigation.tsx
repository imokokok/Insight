...
const umaTabs = (t: (key: string) => string): TabItem[] => [
  ...
  {
    id: 'cross-oracle',
    label: t('uma.menu.crossOracleComparison'),
    icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinejoin="round"
        ...
        return (
          <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={2}
              d="M15 5v2M15 11v2M15 17v2M5 5h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2zm3 6h.01M8 11h.01M8 14h.01"
            />
          </svg>
        );
      case 'analytics':
