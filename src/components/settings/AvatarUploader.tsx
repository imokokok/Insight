...
export function AvatarUploader({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
      <div className="w-20 h-20 rounded-full bg-slate-200 flex items-center justify-center overflow-hidden relative ring-2 ring-slate-100">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-xs text-slate-500">JPG, PNG, WebP or GIF. Max 2MB.</p>
      </div>
    </div>
  );
}
