...
import { AlertCircle, Check, Coins, Copy, Key, Loader2, Plus, Trash2 } from 'lucide-react';
    ...
    <div className={className}>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mt-0.5">
                Create and manage API keys to access the Insight API. Every call is metered against
                your credit balance.
              </p>
            </div>
          </div>
      ...
      <div className="mt-6 p-4 bg-slate-50 rounded-xl border border-slate-100 text-sm text-slate-600">
        ...
        <p>
          ...
          balance covers its cost. Add credits (pay-as-you-go) or subscribe for a monthly credit
          allowance at{' '}
          <Link
