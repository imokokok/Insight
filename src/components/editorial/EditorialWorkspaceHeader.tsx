...
export function EditorialWorkspaceHeader({
  ...
  return (
    <header className="editorial-header relative overflow-hidden border-b border-slate-900/15 pb-9 pt-4 sm:pb-12 sm:pt-8 lg:pb-14">
      <div className="grid gap-8 lg:grid-cols-[0.68fr_1.32fr] lg:gap-16">
        ...
        <div>
          <h1 className="editorial-header-title font-display max-w-4xl text-4xl font-semibold leading-[0.96] tracking-[-0.065em] text-slate-950 sm:text-5xl lg:text-6xl xl:text-7xl">
            {title}
          </h1>
          <p className="mt-6 max-w-2xl text-base leading-relaxed text-slate-600 sm:text-lg">
            {description}
          </p>
          <ul className="editorial-evidence-list mt-9 grid border-y border-slate-900/15 sm:grid-cols-3 sm:divide-x sm:divide-slate-900/10">
