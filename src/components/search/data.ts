...
function getBlockchainSearchResults(): SearchResult[] {
  return BLOCKCHAIN_VALUES.map((chain) => ({
    ...
    href: `/price-insight?chain=${chain.toLowerCase()}`,
...
function getPairSearchResults(): SearchResult[] {
  return symbols.map((symbol) => ({
    id: `pair-${symbol}`,
    title: `${symbol}/USD`,
    description: 'Current price feed data',
...
function getPageSearchResults(): SearchResult[] {
  return [
    ...
    },
    {
      id: 'page-price-query',
      title: 'Price Query',
      description: 'Search and view current price data',
      type: 'page',
      href: `/price-query`,
      icon: Search,
    ...
    {
      id: 'page-price-insight',
      title: 'Price Insight',
      description: 'Compare oracle prices across providers and blockchains',
      type: 'page',
      href: `/price-insight`,
      icon: GitCompare,
