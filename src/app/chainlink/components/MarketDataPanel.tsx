...
const mockMarketData = {
  marketCap: 13850000000, // $13.85B
  volume24h: 485000000, // $485M
  circulatingSupply: 608100000, // 608.1M LINK
  totalSupply: 1000000000, // 1B LINK
  fullyDilutedValuation: 22780000000, // $22.78B
  marketCapRank: 12,
  high24h: 23.45,
  low24h: 22.18,
  change24h: 5.67, // +5.67%
...
export function MarketDataPanel() {
  const [price, setPrice] = useState<number>(22.78);
  const [previousPrice, setPreviousPrice] = useState<number>(22.78);
  ...
  const fetchPrice = useCallback(async () => {
    ...
    try {
      const priceData = await chainlinkClient.getPrice('LINK', Blockchain.ETHEREUM);
  ...
  const metrics = [
    ...
    },
    {
      ...
      value: `${formatNumber(mockMarketData.circulatingSupply, true)} LINK`,
