  ...
  data.forEach((point, index) => {
    ...
    if (Math.abs(deviation) > threshold) {
      anomalies.push({
        ...
        label,
        deviation,
        reason: deviation > 0 ? '价格偏高（超过2σ）' : '价格偏低（超过2σ）',
      });
    }
  });
    ...
    <div className="mb-8 pb-8 border-b border-gray-200">
      ...
      <div className="flex flex-wrap items-center gap-4 mb-4">
        ...
        <label className="inline-flex items-center gap-2 cursor-pointer">
          ...
          <span className="text-sm text-gray-600">
            {t('priceQuery.chart.bollingerBands') || '布林带'}
          </span>
        </label>
        <label className="inline-flex items-center gap-2 cursor-pointer">
          <input
          ...
          />
          <span className="text-sm text-gray-600">
            {t('priceQuery.chart.confidenceInterval') || '置信区间'}
          </span>
        </label>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-4 mb-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
        ...
        <label className="inline-flex items-center gap-2 cursor-pointer">
          ...
          />
          <span className="text-sm text-gray-600">异常点标记</span>
        ...
        <label className="inline-flex items-center gap-2 cursor-pointer">
          ...
          />
          <span className="text-sm text-gray-600">价格突变</span>
        ...
        <label className="inline-flex items-center gap-2 cursor-pointer">
          <input
            ...
            className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
          />
          <span className="text-sm text-gray-600">数值标注</span>
        </label>
      </div>
