  ...
  return (
    <td className="py-2.5 px-3">
      <div className="flex flex-col items-center gap-1">
        ...
        <span className="text-[9px] text-slate-400">{ratio.toFixed(1)}x expected</span>
      </div>
    </td>
  );
});
  ...
  return (
    <div className="relative" style={{ width: size, height: size }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <span className="text-[9px] text-slate-500">{grade.label}</span>
      </div>
    </div>
  );
});
...
export const DistributionBar = memo(function DistributionBar({
  ...
  return (
    <div className="space-y-2">
      <div className="h-3 flex rounded-full overflow-hidden bg-slate-200 shadow-inner">
        {freshCount > 0 && (
          <div
