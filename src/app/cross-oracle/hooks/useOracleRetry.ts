...
export function useOracleRetry({
  ...
  useEffect(() => {
    /* eslint-disable react-hooks/exhaustive-deps -- Map refs must be read at cleanup time to abort all live controllers; capturing at setup would miss later additions */
    return () => {
