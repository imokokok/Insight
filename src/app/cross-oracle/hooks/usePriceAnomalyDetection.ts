...
export function usePriceAnomalyDetection(
  ...
  return useMemo(() => {
    // eslint-disable-next-line react-hooks/purity -- Date.now() is intentionally impure: freshness calculation needs current time; memo only recalculates when priceData/medianPrice/symbol change
