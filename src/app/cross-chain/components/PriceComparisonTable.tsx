        ...
        <table className="w-full text-left">
          <thead>
            <tr className="border-b border-gray-200">
              <th
                className="py-3 px-4 text-xs font-medium text-gray-500 uppercase cursor-pointer hover:bg-gray-100"
              ...
              <th
                className="py-3 px-4 text-xs font-medium text-gray-500 uppercase text-right cursor-pointer hover:bg-gray-100"
              ...
              >
                <div className="flex items-center justify-end gap-1">
                  ...
                  <span>
                    {sortColumn === 'diffPercent' ? (sortDirection === 'asc' ? '↑' : '↓') : '↕'}
                  </span>
                </div>
              </th>
          ...
          <tbody>
            {sortedPriceDifferences.map((item) => {
              ...
              return (
                <tr
                  key={item.chain}
                  className={`border-b border-gray-100 hover:bg-gray-50 ${bgColor} ${outlier ? 'ring-1 ring-amber-300' : ''}`}
                >
