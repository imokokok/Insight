        ...
        },
        {
          ...
          suggestion:
            riskMetrics.volatility.level !== 'low'
              ? `Cross-chain volatility at ${riskMetrics.volatility.index.toFixed(1)} (${riskMetrics.volatility.level} level) — significant inter-chain price instability detected; watch for arbitrage or feed manipulation`
