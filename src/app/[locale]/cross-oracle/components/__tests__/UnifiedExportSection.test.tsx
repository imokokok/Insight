...
describe('UnifiedExportSection', () => {
  ...
  it('should call onIncludeTimestampsChange when toggle is clicked', () => {
    ...
    render(<UnifiedExportSection {...mockProps} onIncludeTimestampsChange={onIncludeTimestampsChange} />);
  ...
  it('should call onIncludeMetadataChange when toggle is clicked', () => {
    ...
    render(<UnifiedExportSection {...mockProps} onIncludeMetadataChange={onIncludeMetadataChange} />);
