...
export default function WinklinkPage() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: `${tronIntegration?.integratedDApps?.length ?? 0}`,
      change: '+8',
      changeType: 'positive' as const,
    },
    {
    ...
    },
    {
      ...
      value: `${networkStats?.nodeUptime ?? 99.92}%`,
      change: '+0.05%',
      changeType: 'positive' as const,
    },
  ];
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => exportData()}
                  className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-white bg-pink-600 rounded-md hover:bg-pink-700"
                >
