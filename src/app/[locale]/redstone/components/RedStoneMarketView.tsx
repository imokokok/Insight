...
export function RedStoneMarketView({
  ...
  const networkStatus = [
    { label: t('redstone.networkHealth.activeNodes'), value: `${networkStats?.activeNodes || 25}+`, status: 'healthy' as const, icon: Server },
    { label: t('redstone.stats.dataFeeds'), value: `${networkStats?.dataFeeds || 1000}+`, status: 'healthy' as const, icon: Zap },
    { label: t('redstone.networkHealth.responseTime'), value: `${networkStats?.avgResponseTime || 200}ms`, status: 'healthy' as const, icon: Clock },
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div>
            ...
            <p className="text-3xl font-semibold text-gray-900">${isLoading ? '-' : currentPrice.toFixed(2)}</p>
