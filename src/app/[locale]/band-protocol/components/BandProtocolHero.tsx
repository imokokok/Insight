    ...
    <div className="bg-white border border-gray-200 rounded-lg p-3">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs font-mono" style={{ color: themeColor }}>~85 次</span>
        </div>
      </div>
    </div>
  );
            ...
            {updates.map((update, index) => (
              <div key={index} className="flex items-center gap-2 text-xs">
                <span 
                  ...
                  style={{ 
                    backgroundColor: 
                      update.type === 'price' ? themeColor :
                      update.type === 'validator' ? '#10b981' :
                      update.type === 'feed' ? '#8b5cf6' : '#6b7280'
                  }}
                />
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
          <div className="flex items-center gap-4">
            ...
            >
              <img
                src="/logos/oracles/band-protocol.svg"
                alt="Band Protocol"
                className="w-8 h-8"
              />
            </div>
            <div>
              ...
              <p className="text-sm text-gray-500">{t('bandProtocol.subtitle')}</p>
            </div>
          </div>
