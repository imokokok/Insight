  ...
  const stats = [
    {
      ...
      value: `${config.networkData.bandProtocolMetrics?.activeValidators || 70}+`,
      change: '+2%',
      changeType: 'positive' as const,
    },
    {
      title: t('bandProtocol.stats.supportedChains'),
      value: `${config.supportedChains.length}+`,
      change: '0%',
      changeType: 'neutral' as const,
    },
    {
      title: t('bandProtocol.stats.dataFeeds'),
      value: `${config.networkData.dataFeeds.toLocaleString()}+`,
      change: '+8%',
      changeType: 'positive' as const,
    },
    {
      title: t('bandProtocol.stats.stakingRatio'),
