...
function StatsCards({ t }: StatsCardsProps) {
  return (
...
function ChartsSection({ triggerDistribution, t }: ChartsSectionProps) {
  return (
...
function ExecutionStats({ successRate, avgGasUsed, avgLatency, t }: ExecutionStatsProps) {
  return (
...
function ManagementSection({ activeTasks, pausedTasks, t }: ManagementSectionProps) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div className="bg-white rounded-lg border border-gray-200 p-5">
        <div className="flex items-center justify-between mb-4">
...
export function ChainlinkAutomationView() {
  ...
  return (
    <div className="space-y-6">
      ...
      <ChartsSection triggerDistribution={triggerDistribution} t={t} />
      ...
      <ManagementSection activeTasks={activeTasks} pausedTasks={pausedTasks} t={t} />
