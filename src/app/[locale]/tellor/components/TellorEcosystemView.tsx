...
const tvlTrendData = [
  { month: '2024-01', ethereum: 450, arbitrum: 120, polygon: 85, optimism: 65, base: 25, total: 745 },
  { month: '2024-02', ethereum: 480, arbitrum: 135, polygon: 92, optimism: 72, base: 35, total: 814 },
  { month: '2024-03', ethereum: 520, arbitrum: 155, polygon: 105, optimism: 85, base: 48, total: 913 },
  { month: '2024-04', ethereum: 495, arbitrum: 168, polygon: 98, optimism: 92, base: 62, total: 915 },
  { month: '2024-05', ethereum: 550, arbitrum: 185, polygon: 115, optimism: 105, base: 78, total: 1033 },
  { month: '2024-06', ethereum: 620, arbitrum: 210, polygon: 128, optimism: 118, base: 95, total: 1171 },
  { month: '2024-07', ethereum: 585, arbitrum: 225, polygon: 122, optimism: 132, base: 115, total: 1179 },
  { month: '2024-08', ethereum: 650, arbitrum: 248, polygon: 145, optimism: 148, base: 138, total: 1329 },
  { month: '2024-09', ethereum: 720, arbitrum: 275, polygon: 162, optimism: 165, base: 165, total: 1487 },
  { month: '2024-10', ethereum: 695, arbitrum: 295, polygon: 175, optimism: 182, base: 192, total: 1539 },
  { month: '2024-11', ethereum: 780, arbitrum: 325, polygon: 195, optimism: 205, base: 225, total: 1730 },
  { month: '2024-12', ethereum: 850, arbitrum: 355, polygon: 220, optimism: 235, base: 265, total: 1925 },
];
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Total Value Locked across Tellor ecosystem</p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-baseline gap-2 mt-1">
              <p className="text-xl font-semibold text-gray-900">
                ${(tvlStats.breakdown[1].value + tvlStats.breakdown[3].value + tvlStats.breakdown[4].value).toFixed(0)}M
              </p>
              <span className="text-xs text-gray-500">
                {(((tvlStats.breakdown[1].value + tvlStats.breakdown[3].value + tvlStats.breakdown[4].value) / tvlStats.current) * 100).toFixed(1)}%
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <section>
          ...
          <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100 text-sm">
            <span className="text-gray-500">{t('ecosystem.projectAnalysis.totalProjects') || 'Total Projects'}: <span className="font-medium text-gray-900">58</span></span>
            <span className="text-emerald-600 font-medium">+8 {t('ecosystem.projectAnalysis.thisMonth') || 'this month'}</span>
          </div>
        </section>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-600">{t('ecosystem.growth.protocols') || 'Protocols'}</span>
              </div>
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-600">{t('ecosystem.growth.chains') || 'Supported Chains'}</span>
              </div>
              <div className="text-right">
            ...
            <div className="flex items-center justify-between py-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-600">{t('ecosystem.growth.tvlGrowth') || 'TVL Growth'}</span>
              </div>
              <div className="text-right">
