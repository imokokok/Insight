    ...
    <div className="bg-white border border-gray-200 rounded-lg p-3 hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-2">
          <div className="p-1.5 bg-cyan-50 text-cyan-600 rounded-md">{icon}</div>
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-3">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs font-mono text-cyan-600">~85 次</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-3">
      <div className="flex items-center justify-between mb-2">
        ...
        <span className="text-xs text-cyan-600 font-medium">{chains.length}+ 链</span>
      </div>
      <div className="flex flex-wrap gap-1.5">
        ...
        {!showAll && chains.length > 6 && (
          <button
            ...
            className="px-2 py-1 text-cyan-600 text-xs hover:bg-cyan-50 rounded-md transition-colors"
          >
            +{chains.length - 6}
          </button>
        )}
...
function LatestUpdates() {
  const updates = [
    { type: 'price', text: 'TRB 价格更新: $45.23 (+3.2%)', time: '2分钟前' },
    { type: 'reporter', text: '新报告者加入: 0x3f8a...9b2c (北美地区)', time: '5分钟前' },
    { type: 'feed', text: 'BTC/USD 数据喂价更新', time: '8分钟前' },
    { type: 'system', text: 'Tellor 协议升级完成', time: '15分钟前' },
  ];
...
export function TellorHero({
  ...
  const stats: StatCardProps[] = [
    ...
    },
    {
      ...
      subtitle: `APR ${config.marketData.stakingApr ?? 15}%`,
    },
    {
      title: '平均响应',
  ...
  // 获取主题色
  const themeColor = config.themeColor || '#0891b2';
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
          <div className="flex items-center gap-4">
            ...
            >
              <img src="/logos/oracles/tellor.svg" alt="Tellor" className="w-8 h-8" />
            </div>
            <div>
