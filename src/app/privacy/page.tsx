              ...
              <div className="text-slate-700 leading-relaxed space-y-3">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    ...
                    privacy-preserving traffic and performance metrics. These only load after you
                    opt in to the &quot;Analytics&quot; cookie category.
                  </li>
                  <li>
                    <strong>NOWPayments:</strong> For crypto payment processing of paid
                    subscriptions (USDC-denominated). NOWPayments receives your transaction details
                    (invoice ID, payment amount, settlement currency) needed to process payments. We
                    never store your wallet private keys or seed phrases.
                  </li>
                </ul>
                <p>
              ...
              <div className="text-slate-700 leading-relaxed space-y-3">
                ...
                <div className="space-y-2">
                  <p>
                    ...
                    management, and security. These cannot be disabled, as the Platform cannot
                    operate without them.
                  </p>
                  <p>
                    <strong>Analytics cookies</strong> — Vercel Analytics, Speed Insights, and
                    Sentry. These help us understand usage patterns and diagnose errors. They are
                ...
                <p>
                  ...
                  choose which categories to allow. You may (i) accept all categories, (ii) reject
                  all non-essential cookies, or (iii) customize your preferences per category. We
                  will not set any non-essential cookies until you have made a choice.
                </p>
                <p>
                  To change your cookie preferences later, clear your browser&apos;s local storage
                  for this site (which will re-display the banner) or contact us at{' '}
                  <a
