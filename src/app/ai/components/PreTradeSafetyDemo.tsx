...
function BufferConsumptionBar({ safety }: { safety: ProtocolSafetyContext }) {
...
const ACTION_SEVERITY_STYLE: Record<LendingSafetyAction['severity'], string> = {
