      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="relative">
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-700">{currentMetric.metric.name}</span>
            <ChevronDown
            ...
            <div className="absolute top-full left-0 mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
              <div className="p-2">
                {data.map((item) => (
                  ...
                  >
                    <div className="text-sm font-medium">{item.metric.name}</div>
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          <div className="flex items-center gap-2">
            <span className="text-gray-500">{locale === 'zh-CN' ? '行业中位数' : 'Median'}:</span>
            <span className="font-semibold text-gray-900">
          ...
          <div className="flex items-center gap-2">
            <span className="text-gray-500">{locale === 'zh-CN' ? '行业最佳' : 'Best'}:</span>
              ...
              .map((ov) => (
                <tr key={ov.oracle} className="hover:bg-gray-50">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-3 rounded-full" style={{ backgroundColor: ov.color }} />
                      <span className="font-medium text-gray-900">{ov.oracle}</span>
                    </div>
                  </td>
                  ...
                  <td className="px-4 py-3 text-right">
                    <span className={`font-medium ${getPerformanceClass(ov.diffPercent)}`}>
                      {ov.diffPercent > 0 ? '+' : ''}
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <span className="text-sm text-gray-600">Top {ov.percentile}%</span>
                    </div>
                  </td>
