...
function generateInsights(
  ...
  if (
    ...
    insights.push({
      ...
      description: `Overall feed health is ${props.feedHealthLevel} (avg ${props.feedHealthAvg.toFixed(0)}/100) while risk is ${props.riskLevel}. Degraded feeds during high-risk periods produce unreliable prices. Consider increasing monitoring frequency or temporarily switching to more reliable ${entityLabel} sources.`,
      relatedDimensions: ['Feed Health', 'Risk Analysis'],
    });
  }
