...
// Top-level error boundary: an OAuth callback is reached via email links, so
// any unexpected error (e.g. a transient Supabase/network failure) must degrade
// to a helpful redirect rather than surfacing as an opaque 500. This mirrors
// the route's own pattern of redirecting to /auth/verify-email?error=... for
