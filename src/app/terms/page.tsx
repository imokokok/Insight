    ...
    <div className="editorial-workspace min-h-screen px-5 py-10 sm:px-8 sm:py-14">
      <article className="editorial-frame mx-auto max-w-5xl">
        <header className="mb-12 grid gap-6 border-b border-slate-900/15 pb-10 lg:grid-cols-[0.7fr_1.3fr]">
          <div>
            <p className="editorial-index">16 — Governance</p>
          ...
          <div>
            ...
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-slate-600">
              The operating terms for using Insight data, analysis, accounts, and programmatic
              access.
            </p>
          </div>
        </header>
        ...
        <div className="prose prose-slate max-w-none bg-white/35 px-0 py-2 sm:px-8">
          <section className="mb-8">
            ...
            <p className="text-slate-700 leading-relaxed">
              By accessing and using Insight (&quot;the Platform&quot;), you accept and agree to be
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-700 leading-relaxed">
              The Platform aggregates and displays data from third-party oracle providers. While we
              strive for accuracy, we cannot guarantee that all data is accurate, complete, or
              current. The data provided through the Platform is for informational purposes only and
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-700 leading-relaxed">
              ...
              Insight and is protected by international copyright, trademark, and other intellectual
              property laws. Oracle data and logos are property of their respective providers.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-700 leading-relaxed">
              To the maximum extent permitted by law, Insight shall not be liable for any indirect,
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-slate-900 mb-3">8. Service Modifications</h2>
            <p className="text-slate-700 leading-relaxed">
              We reserve the right to modify, suspend, or discontinue any part of the Platform at
              any time without prior notice. We shall not be liable to you or to any third party for
