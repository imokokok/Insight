...
function AlertBadge({ type, message }: { type: 'info' | 'warning' | 'success'; message: string }) {
  ...
  return (
    <div className={`flex items-center gap-1.5 px-2 py-1 rounded-md border ${styles[type]} text-[10px] font-medium mt-2`}>
          ...
          {[...liveTickerData, ...liveTickerData, ...liveTickerData].map((item, index) => (
            ...
            >
              ...
              <div className="flex flex-col items-end">
                ...
                <span className={`text-[10px] font-medium ${item.isPositive ? 'text-emerald-600' : 'text-rose-600'}`}>
        ...
        <div className="h-28 mt-5 w-full min-h-[112px]">
          <ResponsiveContainer width="100%" height={112}>
            <AreaChart data={card.chartData} margin={{ top: 5, right: 5, left: 0, bottom: 5 }}>
              ...
              <Tooltip content={<ChartTooltip />} cursor={{ stroke: colors.chart, strokeWidth: 1, strokeDasharray: '4 4' }} />
              <Area 
                type="monotone" 
                dataKey="value" 
                stroke={colors.chart} 
              ...
              >
                ...
                <div className="relative p-5 sm:p-6 h-full flex flex-col">
                  ...
                  <div className="flex-1">
                    ...
                    {/* Alert Badge */}
                    {card.alert && <AlertBadge type={card.alert.type} message={card.alert.message} />}
                  </div>
