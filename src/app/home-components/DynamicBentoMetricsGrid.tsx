      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 xl:px-20">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-200 mb-5 animate-pulse">
              <div className="w-4 h-4 bg-blue-200" />
              <div className="w-20 h-4 bg-blue-200" />
            </div>
            <div className="h-10 w-64 bg-gray-200 mx-auto mb-4 animate-pulse" />
            <div className="h-6 w-96 bg-gray-200 mx-auto animate-pulse" />
          </div>
