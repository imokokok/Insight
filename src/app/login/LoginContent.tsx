...
function LoginForm() {
  ...
  return (
    <AuthPageLayout bgClass="bg-gray-50" cardClassName="shadow-sm">
      <div className="text-center mb-8">
        <AuthBrandLogo />
        <h2 className="mt-4 text-xl font-semibold text-gray-900">Login</h2>
        <p className="mt-2 text-sm text-gray-500">Welcome back! Please log in to your account.</p>
      </div>
...
export default function LoginContent() {
  return (
    <AuthPageSuspense bgClass="bg-gray-50">
      <LoginForm />
    </AuthPageSuspense>
  );
}
